        ...
        <div className="container">
          <div className="flex flex-col">
            <Image
              ...
              alt="car_img"
            />
            <div className="flex justify-around mt-6 w-full lg:flex-col lg:items-center lg:text-center lg:gap-[5.5rem]">
              <div className="text-left flex flex-col max-w-[50rem] text-black lg:items-center lg:text-center">
                <h4 className='text-[2rem] mb-[0.7rem] font-600 font-mont '>Why Choose Us</h4>
                <h2 className='text-[4rem] leading-[1.2] mb-[2rem]'>Best valued deals you will ever find</h2>
                <p className='text-[1.2rem] font-mont leading-[1.5] text-gray-400 mb-[3.3rem]'>
                ...
                <a 
                  href="#home"
                  className='text-white font-bold bg-red-500 py-6 px-10 rounded-md shadow-md transition-all duration-300 border-2 border-red-500 text-lg 
                  inline-block hover:shadow-md hover:bg-orange-500'
                >
                  Find Details &nbsp;
                  <i className="fa fa-angle-right"><FaAngleRight /></i>
                </a>
              </div>
              <div className="flex flex-col gap-[4.5rem] max-w-[44rem]">
                ...
                <div className="flex sm:flex-col sm:items-center">
                  ...
                  <div className="flex flex-col gap-[1rem] justify-center ">
                    <h4 className='text-[3rem]'>Cross Country Drive</h4>
                    <p className='text-[1rem] text-gray-500 font-mont leading-[1.3]'>
                ...
                <div className="flex sm:flex-col sm:items-center">
                  ...
                  <div className="flex flex-col gap-[1rem] justify-center ">
                    <h4 className='text-[3rem]'>All Inclusive Pricing</h4>
                    <p className='text-[1rem] text-gray-500 font-mont leading-[1.3]'>
                ...
                <div className="flex sm:flex-col sm:items-center">
                  ...
                  <div className="flex flex-col gap-[1rem] justify-center">
                    <h4 className='text-[3rem]'>No Hidden Charges</h4>
                    <p className='text-[1rem] text-gray-500 font-mont leading-[1.3]'>
